  ...
  return (
    <div className="relative px-4 py-12 text-gray-800 dark:text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          How It <span className="text-purple-500 dark:text-purple-400">Works</span>
        </motion.h1>
        ...
        >
          BrainPin makes capturing and organizing your thoughts effortless with our simple four-step process.
        </motion.p>
      </div>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <motion.div variants={itemVariants} className="relative">
            ...
            >
              ...
              <p className="text-base md:text-lg font-medium text-gray-600 dark:text-gray-300 mb-6">
                When inspiration strikes, quickly jot down your ideas in BrainPin. Use our intuitive editor to capture
                text, images, links, or voice notes.
              </p>
              <div ref={svgOneInViewRef} className="flex items-center justify-center h-48 md:h-64 relative">
                <motion.div
                  ref={svgOneRef}
                ...
                >
                  <img src="/one.svg" alt="Capture" className="w-full h-full object-contain" />
                </motion.div>
              </div>
            </motion.div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="relative">
            ...
            >
              <h3 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">Organize & Tag</h3>
              <p className="text-base md:text-lg font-medium text-gray-600 dark:text-gray-300 mb-6">
                Add tags, categories, and organize your thoughts into collections. Our smart system helps categorize
                related ideas automatically.
              </p>
              <div ref={svgTwoInViewRef} className="flex items-center justify-center h-48 md:h-64 relative">
                <motion.div
                  ref={svgTwoRef}
                  ...
                  style={{ transformStyle: "preserve-3d" }}
                >
                  <img src="/two.svg" alt="Organize" className="w-full h-full object-contain" />
                </motion.div>
              </div>
            </motion.div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="relative">
            <div className="absolute -left-4 -top-4 w-12 h-12 rounded-full bg-rose-100 dark:bg-rose-900/30 flex items-center justify-center z-10">
              <span className="text-2xl font-bold text-rose-600 dark:text-rose-400">3</span>
            </div>
            <motion.div
              whileHover={{ scale: 1.02 }}
              transition={{ duration: 0.2 }}
            ...
            >
              <h3 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">Connect Ideas</h3>
              <p className="text-base md:text-lg font-medium text-gray-600 dark:text-gray-300 mb-6">
                Discover connections between your thoughts with our intelligent linking system. Create mind maps and
                visualize relationships between concepts.
              </p>
              <div ref={svgThreeInViewRef} className="flex items-center justify-center h-48 md:h-64 relative">
                <motion.div
                  ref={svgThreeRef}
                  ...
                  style={{ transformStyle: "preserve-3d" }}
                >
                  <img src="/three.svg" alt="Connect" className="w-full h-full object-contain" />
                </motion.div>
              </div>
            </motion.div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="relative">
            <div className="absolute -left-4 -top-4 w-12 h-12 rounded-full bg-violet-100 dark:bg-violet-900/30 flex items-center justify-center z-10">
              <span className="text-2xl font-bold text-violet-600 dark:text-violet-400">4</span>
            </div>
            <motion.div
              whileHover={{ scale: 1.02 }}
              transition={{ duration: 0.2 }}
            ...
            >
              <h3 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">Revisit & Refine</h3>
              <p className="text-base md:text-lg font-medium text-gray-600 dark:text-gray-300 mb-6">
                Find your ideas when you need them with powerful search. Refine and develop your thoughts over time as
                your understanding evolves.
              </p>
              <div ref={svgFourInViewRef} className="flex items-center justify-center h-48 md:h-64 relative">
                <motion.div
                  ref={svgFourRef}
                  ...
                  style={{ transformStyle: "preserve-3d" }}
                >
                  <img src="/four.svg" alt="Revisit" className="w-full h-full object-contain" />
                </motion.div>
              </div>
            </motion.div>
          </motion.div>
